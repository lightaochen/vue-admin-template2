<template>
  <div class="app-container">
    ...
    <!-- 汇总（价差） -->
    <el-card v-if="summary" v-loading="loading" :gutter="12" style="margin-top: 12px" shadow="never">
    ...
    <el-row v-show="summary && openTrendData" v-loading="loading" :gutter="12" style="margin-top: 12px">
      <el-col :md="24" :sm="24">
        <el-card shadow="never" :body-style="{ padding: '8px' }">
